public class Main {
    ...
    AthleteThread firstAthleteThread=new AthleteThread(23934);
    AthleteThread secondAthleteThread=new AthleteThread(239323);

    firstAthleteThread.start();
    secondAthleteThread.start();
