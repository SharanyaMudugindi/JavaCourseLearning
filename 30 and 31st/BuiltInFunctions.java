public class BuiltInFunctions {
    ...
    public static void main(String[] args) {
         ...
         */
        String example = "Java";
        System.out.println("length off the string: "+example.length());
        ...
        boolean pre= programming.startsWith("java");
        boolean pre1= programming.startsWith("Java");
        System.out.println("Does it start with prefix?"+pre);
        System.out.println("Does it start with prefix?"+pre1);
        ...
        System.err.println("Square root of "+number+" is "+square);
